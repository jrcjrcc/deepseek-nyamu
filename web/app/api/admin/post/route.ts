...
export async function POST(req: Request) {
  ...
  // CSRF protection: require either a matching Origin header (browser
  // same-origin requests always send it) OR a custom X-Requested-With
  // header that browsers won't set cross-origin. This prevents cookie-
  // based CSRF from other origins via simple requests.
