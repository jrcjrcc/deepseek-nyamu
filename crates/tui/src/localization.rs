...
pub enum MessageId {
    ...
    CtxCopySelection,
    CtxCopySelectionDesc,
    CtxOpenSelection,
    CtxOpenSelectionDesc,
    CtxClearSelection,
    CtxPaste,
    CtxPasteDesc,
    CtxOpenDetails,
    ...
    CtxShowHiddenDesc,
    CtxCommandPalette,
    CtxCommandPaletteDesc,
    CtxContextInspector,
    CtxContextInspectorDesc,
    CtxHelp,
    CtxHelpDesc,
    CtxMenuTitle,
    // Sidebar and work/task panel labels.
    SidebarWork,
    SidebarTasks,
    SidebarNoActiveWork,
    SidebarNoLiveTools,
    SidebarLiveTools,
    SidebarBackgroundRunning,
    SidebarBackgroundCompleted,
    SidebarAgentRunning,
    SidebarAgentDone,
    SidebarAgentFailed,
    SidebarBackgroundHeader,
    SidebarAgentInterrupted,
    SidebarAgentCancelled,
}
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::CtxCopySelection,
    MessageId::CtxCopySelectionDesc,
    MessageId::CtxOpenSelection,
    MessageId::CtxOpenSelectionDesc,
    MessageId::CtxClearSelection,
    MessageId::CtxPaste,
    MessageId::CtxPasteDesc,
    MessageId::CtxOpenDetails,
    MessageId::CtxCopyMessage,
    MessageId::CtxCopyMessageDesc,
    MessageId::CtxOpenInEditor,
    MessageId::CtxOpenInEditorDesc,
    MessageId::CtxShowCell,
    MessageId::CtxShowCellDesc,
    MessageId::CtxHideCell,
    MessageId::CtxHideCellDesc,
    MessageId::CtxShowHidden,
    MessageId::CtxShowHiddenDesc,
    MessageId::CtxCommandPalette,
    MessageId::CtxCommandPaletteDesc,
    MessageId::CtxContextInspector,
    MessageId::CtxContextInspectorDesc,
    MessageId::CtxHelp,
    MessageId::CtxHelpDesc,
    ...
    MessageId::SidebarBackgroundRunning,
    MessageId::SidebarBackgroundCompleted,
    MessageId::SidebarAgentRunning,
    MessageId::SidebarAgentDone,
    MessageId::SidebarAgentFailed,
    MessageId::SidebarBackgroundHeader,
    MessageId::SidebarAgentInterrupted,
    MessageId::SidebarAgentCancelled,
];
...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::CtxCopySelection => "Copy selection",
        MessageId::CtxCopySelectionDesc => "write selected transcript text",
        MessageId::CtxOpenSelection => "Open selection",
        MessageId::CtxOpenSelectionDesc => "show selected text in pager",
        MessageId::CtxClearSelection => "Clear selection",
        MessageId::CtxPaste => "Paste",
        MessageId::CtxPasteDesc => "insert clipboard into composer",
        MessageId::CtxOpenDetails => "Open details",
        MessageId::CtxCopyMessage => "Copy message",
        MessageId::CtxCopyMessageDesc => "write clicked transcript cell",
        MessageId::CtxOpenInEditor => "Open in editor",
        MessageId::CtxOpenInEditorDesc => "open file:line in $EDITOR",
        MessageId::CtxShowCell => "Show cell",
        MessageId::CtxShowCellDesc => "unhide this transcript cell",
        MessageId::CtxHideCell => "Hide cell",
        MessageId::CtxHideCellDesc => "collapse this transcript cell",
        MessageId::CtxShowHidden => "Show hidden ({count})",
        MessageId::CtxShowHiddenDesc => "unhide all collapsed cells",
        MessageId::CtxCommandPalette => "Command palette",
        MessageId::CtxCommandPaletteDesc => "commands, skills, and tools",
        MessageId::CtxContextInspector => "Context inspector",
        MessageId::CtxContextInspectorDesc => "active context and cache hints",
        MessageId::CtxHelp => "Help",
        MessageId::CtxHelpDesc => "keybindings and commands",
        ...
        MessageId::SidebarBackgroundRunning => "running",
        MessageId::SidebarBackgroundCompleted => "completed",
        MessageId::SidebarAgentRunning => "running",
        MessageId::SidebarAgentDone => "done",
        MessageId::SidebarAgentFailed => "failed",
        MessageId::SidebarBackgroundHeader => "Background commands",
        MessageId::SidebarAgentInterrupted => "interrupted",
        MessageId::SidebarAgentCancelled => "canceled",
    }
}
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CtxCopySelection => "复制选中内容",
        MessageId::CtxCopySelectionDesc => "写入选中的对话文本",
        MessageId::CtxOpenSelection => "打开选中内容",
        MessageId::CtxOpenSelectionDesc => "在分页器中查看",
        MessageId::CtxClearSelection => "清除选中",
        MessageId::CtxPaste => "粘贴",
        MessageId::CtxPasteDesc => "从剪贴板插入到输入框",
        MessageId::CtxOpenDetails => "查看详情",
        MessageId::CtxCopyMessage => "复制消息",
        MessageId::CtxCopyMessageDesc => "复制点击的对话单元",
        MessageId::CtxOpenInEditor => "在编辑器中打开",
        MessageId::CtxOpenInEditorDesc => "在 $EDITOR 中打开文件",
        MessageId::CtxShowCell => "显示单元",
        MessageId::CtxShowCellDesc => "取消隐藏此对话单元",
        MessageId::CtxHideCell => "隐藏单元",
        MessageId::CtxHideCellDesc => "折叠此对话单元",
        MessageId::CtxShowHidden => "显示隐藏项 ({count})",
        MessageId::CtxShowHiddenDesc => "取消隐藏所有折叠单元",
        MessageId::CtxCommandPalette => "命令面板",
        MessageId::CtxCommandPaletteDesc => "命令、技能和工具",
        MessageId::CtxContextInspector => "上下文检查器",
        MessageId::CtxContextInspectorDesc => "活跃上下文与缓存提示",
        MessageId::CtxHelp => "帮助",
        MessageId::CtxHelpDesc => "快捷键和命令帮助",
        MessageId::CtxMenuTitle => "右键菜单",
        MessageId::SidebarWork => "工作",
        MessageId::SidebarTasks => "任务",
        MessageId::SidebarNoActiveWork => "暂无活动工作",
        MessageId::SidebarNoLiveTools => "没有正在运行的工具或后台任务",
        MessageId::SidebarLiveTools => "活动工具",
        MessageId::SidebarBackgroundRunning => "运行中",
        MessageId::SidebarBackgroundCompleted => "已完成",
        MessageId::SidebarAgentRunning => "运行中",
        MessageId::SidebarAgentDone => "已完成",
        MessageId::SidebarAgentFailed => "失败",
        MessageId::SidebarBackgroundHeader => "后台命令",
        MessageId::SidebarAgentInterrupted => "中断",
        MessageId::SidebarAgentCancelled => "已取消",
    })
}
