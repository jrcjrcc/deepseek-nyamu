...
impl Theme {
    ...
    pub const fn dark() -> Self {
        Self {
            ...
            plan_progress_color: palette::STATUS_INFO,
            plan_summary_color: palette::TEXT_DIM,
            plan_explanation_color: palette::TEXT_MUTED,
            plan_pending_color: palette::TEXT_HINT,
    ...
    pub const fn light() -> Self {
        Self {
            ...
            tool_success_accent: palette::LIGHT_SUCCESS,
            tool_failed_accent: palette::DEEPSEEK_RED,
            plan_progress_color: palette::DEEPSEEK_BLUE,
            plan_summary_color: palette::LIGHT_TEXT_HINT,
            plan_explanation_color: palette::LIGHT_TEXT_MUTED,
            plan_pending_color: palette::LIGHT_TEXT_HINT,
            plan_in_progress_color: Color::Rgb(180, 83, 9),
            plan_completed_color: palette::LIGHT_SUCCESS,
        }
    }
